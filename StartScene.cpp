...
void StartScene::Init()
{
	...
	objCredit->Init("./Resource/ui/main/credit/main_credit_basics.bmp", RGB(255, 8, 255), 178, 45, 323, 440);

	objQuit = new Object;
	objQuit->Init("./Resource/ui/main/quit/main_quit_basics.bmp", RGB(255, 8, 255), 178, 45, 323, 518);
}
